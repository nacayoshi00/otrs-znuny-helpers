...
#   exit 1;
#fi
sudo -u otrs  PERL5LIB=/usr/local/share/cpanm/lib/perl5 /opt/otrs/bin/otrs.Console.pl Maint::Database::Check || exit 1

echo "prepare config files"
sudo -u otrs  PERL5LIB=/usr/local/share/cpanm/lib/perl5 /opt/otrs/bin/otrs.Console.pl Dev::Tools::Migrate::ConfigXMLStructure --source-directory Kernel/Config/Files

echo "starting DB migration"
sudo -u otrs  PERL5LIB=/usr/local/share/cpanm/lib/perl5 ./scripts/DBUpdate-to-6.pl

sudo -u otrs  PERL5LIB=/usr/local/share/cpanm/lib/perl5 /opt/otrs/bin/otrs.Console.pl Maint::Cache::Delete
sudo -u otrs  PERL5LIB=/usr/local/share/cpanm/lib/perl5 /opt/otrs/bin/otrs.Console.pl Maint::Session::DeleteAll


echo "upgrading installed packages"
sudo -u otrs  PERL5LIB=/usr/local/share/cpanm/lib/perl5 ./bin/otrs.Console.pl Admin::Package::UpgradeAll
